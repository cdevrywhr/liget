...
function heroMap(urlMap,Url,_latitude,_longitude, element, markerTarget, sidebarResultTarget, showMarkerLabels, mapDefaultZoom){
        ...
        function placeMarkers(markers){
            ...
            for (i = 0; i < markers.length; i++) {
                ...
                if( markers[i]["marker_image"] != undefined ){
                    ...
                    thumbnailImage = Url+"frontEnd/img/items/default.png";
                }
                    ...
                    google.maps.event.addListener(marker, 'click', (function(marker, i) {
                        return function() {
                            if( markerTarget == "sidebar"){
                                ...
                                openModal($(this.content.firstChild).attr("data-id"), "front/modal/"); // 2
                            }
                        }
                    })(marker, i));
            ...
            function openInfobox(id, _this, i){
                $.ajax({
                    url: Url+"frontEnd/external/infobox.php",
                    dataType: "html",
                    data: { id: id },
                    method: "POST",
                    success: function(results){
                        infoboxOptions = {
                            ...
                            closeBoxURL: "frontEnd/img/close-btn.png",
                        ...
                        google.maps.event.addListener(marker, 'click', (function(marker, i) {
                            return function() {
                                if( markerTarget == "sidebar"){
                                    ...
                                    openModal($(this.content.firstChild).attr("data-id"), "front/modal/"); // 3
                                }
            ...
            function openSidebarDetail(id){
                $.ajax({
                    url: "frontEnd/external/sidebar_detail.php",
                    data: { id: id },
                    method: "POST",
                    success: function(results){
			...
			*/
            ...
            function renderResults(){
                ...
                if( $(".hero-section").hasClass("sidebar-grid") ){
                    // var sidebarUrl = "frontEnd/external/sidebar_results_grid.php";
                    var sidebarUrl =  Url+"front/sidebar";
                }
                else {
                    // sidebarUrl = "frontEnd/external/sidebar_results.php";
                     sidebarUrl = Url+"front/sidebar";
                }
                    ...
                    success: function(results){
                        ...
                        $(".result-item").children("a").on("click", function(e){
                            if( sidebarResultTarget == "sidebar" ){
                                ...
                                e.preventDefault();
                                openModal( $(this).parent().attr("data-id"), "front/modal/" ); // 1
                            }
...
function simpleMap(Url,_latitude,_longitude, element, markerDrag, place){
    ...
    function drawMap(mapCenter,Url){
        var mapOptions = {
            zoom: 14,
            center: mapCenter,
        ...
        var marker = new RichMarker({
            ...
            content: "<img src='"+Url+"/frontEnd/img/marker.png'>",
            flat: true
        });
