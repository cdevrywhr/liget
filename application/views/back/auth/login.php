...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg" style="font-weight: bold;font-size:24px">Masuk</p>
      ...
      <div class="row">
        <div class="col-lg-12">
          <a href="<?php echo base_url('auth/register_form') ?>" class="">Daftar</a>
          <a href="<?php echo base_url('auth/forgot_password') ?>" class="pull-right">Lupa Password</a>
        </div>
      </div>
