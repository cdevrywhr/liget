    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group"><label>NPWP</label>
                <?php echo form_input($npwp, $user->npwp) ?>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group"><label>NIK</label>
                <?php echo form_input($nik, $user->nik) ?>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group"><label>KTP Sekarang</label>
                <p><img src="<?php echo base_url('assets/images/user/' . $user->photo_thumb) ?>" width="200px" alt="current photo"></p>
                <div class="form-group"><label>Pilih Baru</label>
                  <input type="file" name="photo" id="photo" multiple="" onchange="photoPreview(this,'preview')" />
