    ...
    <div class="user-panel">
      <div class="pull-left image">
        <?php if ($this->session->photo_thumb == NULL) { ?>
          <img src="<?php echo base_url('assets/images/users/default.png') ?>" class="img-circle" alt="No Image Found">
        <?php } else { ?>
          <img src="<?php echo base_url('assets/images/users/default.png') ?>" class="img-circle" alt="<?php echo $this->session->name ?>">
        <?php } ?>
      </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php foreach ($menu as $m) { ?>
        ...
        <?php } else {
          ...
          if ($this->uri->segment(1) == $m->menu_slug) {
      ...
      <?php if (is_superadmin()) { ?>
        <li class="<?php if ($this->uri->segment(1) == 'auth' && $this->uri->segment(2) == 'log_list') {
                      echo "active";
                    } ?>">
          <a href="<?php echo base_url('auth/log_list') ?>">
            <i class="fa fa-clock-o"></i>
            <span>Log System Process</span>
          </a>
        </li>
        <li class="<?php if ($this->uri->segment(1) == 'company') {
                      echo "active";
                    } ?>"><a href="<?php echo base_url('company/update/1') ?>"><i class="fa fa-building"></i> <span>Company Profile</span></a></li>
        <li class="<?php if ($this->uri->segment(1) == 'auth' && $this->uri->segment(2) != 'log_list') {
                      echo "active";
                    } ?> treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php if ($this->uri->segment(1) == 'auth' && $this->uri->segment(2) == 'create') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('auth/create') ?>"><i class="fa fa-circle-o"></i> Add User</a></li>
            <li <?php if ($this->uri->segment(1) == 'auth' && $this->uri->segment(2) == '') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('auth') ?>"><i class="fa fa-circle-o"></i> User List</a></li>
            <li <?php if ($this->uri->segment(1) == 'auth' && $this->uri->segment(2) == 'deleted_list') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('auth/deleted_list') ?>"><i class="fa fa-circle-o"></i> Recycle Bin</a></li>
          </ul>
        </li>
        <li class="<?php if ($this->uri->segment(1) == 'usertype') {
                      echo "active";
                    } ?> treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php if ($this->uri->segment(1) == 'usertype' && $this->uri->segment(2) == 'create') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('usertype/create') ?>"><i class="fa fa-circle-o"></i> Add Usertype</a></li>
            <li <?php if ($this->uri->segment(1) == 'usertype' && $this->uri->segment(2) == '') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('usertype') ?>"><i class="fa fa-circle-o"></i> Usertype List</a></li>
          </ul>
        </li>
        <li class="<?php if ($this->uri->segment(1) == 'menu') {
          ...
          <ul class="treeview-menu">
            <li <?php if ($this->uri->segment(1) == 'menu' && $this->uri->segment(2) == 'create') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('menu/create') ?>"><i class="fa fa-circle-o"></i> Add Menu</a></li>
            <li <?php if ($this->uri->segment(1) == 'menu' && $this->uri->segment(2) == '') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('menu') ?>"><i class="fa fa-circle-o"></i> Menu List</a></li>
          </ul>
        </li>
        <li class="<?php if ($this->uri->segment(1) == 'submenu') {
                      echo "active";
                    } ?> treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php if ($this->uri->segment(1) == 'submenu' && $this->uri->segment(2) == 'create') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('submenu/create') ?>"><i class="fa fa-circle-o"></i> Add SubMenu</a></li>
            <li <?php if ($this->uri->segment(1) == 'submenu' && $this->uri->segment(2) == '') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('submenu') ?>"><i class="fa fa-circle-o"></i> SubMenu List</a></li>
          </ul>
        </li>
        <li class="<?php if ($this->uri->segment(1) == 'menuaccess') {
                      echo "active";
                    } ?> treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php if ($this->uri->segment(1) == 'menuaccess' && $this->uri->segment(2) == 'create') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('menuaccess/create') ?>"><i class="fa fa-circle-o"></i> Add Menu Access</a></li>
            <li <?php if ($this->uri->segment(1) == 'menuaccess' && $this->uri->segment(2) == '') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('menuaccess') ?>"><i class="fa fa-circle-o"></i> Menu Access List</a></li>
          </ul>
        </li>
        <li class="<?php if ($this->uri->segment(1) == 'template') {
                      echo "active";
                    } ?> treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php if ($this->uri->segment(1) == 'template' && $this->uri->segment(3) == '1') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('template/update/1') ?>"><i class="fa fa-circle-o"></i> Layout</a></li>
            <li <?php if ($this->uri->segment(1) == 'template' && $this->uri->segment(3) == '2') {
                  echo 'class="active"';
                } ?>><a href="<?php echo base_url('template/update/2') ?>"><i class="fa fa-circle-o"></i> Skins</a></li>
          </ul>
        </li>
      <?php } ?>
